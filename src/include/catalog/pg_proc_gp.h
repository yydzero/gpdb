...
DATA(insert OID = 4102 ( numeric_avg_accum  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 17 "17 1700" _null_ _null_ _null_ _null_ numeric_avg_accum _null_ _null_ _null_ n a ));
DESCR("aggregate transition function");
...
DATA(insert OID = 4100 ( int8_avg_accum  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 17 "17 20" _null_ _null_ _null_ _null_ int8_avg_accum _null_ _null_ _null_ n a ));
