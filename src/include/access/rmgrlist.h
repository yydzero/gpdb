...
/* GPDB specific. MERGE_95_FIXME: those identify func. */
PG_RMGR(RM_BITMAP_ID, "Bitmap", bitmap_redo, bitmap_desc, NULL /* bitmap_identify */, NULL, NULL)
PG_RMGR(RM_DISTRIBUTEDLOG_ID, "DistributedLog", DistributedLog_redo, DistributedLog_desc, NULL /* DistributedLog_identify */, NULL, NULL)
PG_RMGR(RM_APPEND_ONLY_ID, "Appendonly Table Log Records", appendonly_redo, appendonly_desc, NULL /* appendonly_identify */, NULL, NULL)
